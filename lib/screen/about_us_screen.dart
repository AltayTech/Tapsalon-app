              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'تاپ سالن یک پلتفرم اطلاع رسانی و رزرو سالن های ورزشی، تفریحی، باشگاه ها می باشد.  تاپ سالن درصدد است با تحت پوشش قرار دادن تمامی اماکن ورزشی و تفریحی سراسر کشور بتواند خدمات جامعی در زمینه اطلاعات اماکن ورزشی ارائه بدهد',
