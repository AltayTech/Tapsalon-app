...
class SalonDetailRTimingScreen extends StatefulWidget {
  final Place place;

  SalonDetailRTimingScreen({this.place});

  @override
  _SalonDetailRTimingScreenState createState() =>
      _SalonDetailRTimingScreenState();
}

class _SalonDetailRTimingScreenState extends State<SalonDetailRTimingScreen> {
  var _isLoadingMonth;
  var _isLoadingTable;
  bool _isInit = true;
